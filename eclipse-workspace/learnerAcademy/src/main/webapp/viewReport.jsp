...
if(mySession==null){
	...
	response.setHeader("refresh", "5;url='/learnerAcademy'");
}
else{
...
<tr><td>&nbsp;&nbsp;<a href="/learnerAcademy/Dashboard.jsp">Dashboard</a>&nbsp;&nbsp;</td></tr>
</table>
<br/>
<br/>
...
response.sendRedirect("learnerAcademy/Dashboard.jsp");
%>
