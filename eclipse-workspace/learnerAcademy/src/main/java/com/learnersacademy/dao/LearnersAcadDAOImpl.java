...
//			String sql = "{call la_update_record_pkg.upd_subject(?,?,?,?,?,?,?)}";
			String sql = "update learnersacademy.tab_subject set "
					+ "sub_name = ?, sub_lang = ?, class_id = ?, teacher_id = ? "
					+ "where sub_id = ?";
			CallableStatement callableStatement = connection.prepareCall(sql);
			callableStatement.setInt(5, subject.getSubjectID());
			callableStatement.setString(1,subject.getSubName());
			callableStatement.setString(2,subject.getSubLang());
			callableStatement.setInt(3,subject.getClassId());
			callableStatement.setInt(4,subject.getTeacherId());
...
//			String sql = "{call la_update_record_pkg.upd_student(?,?,?,?,?,?)}";
			String sql = "update learnersacademy.tab_student set "
					+ "student_name = ?, student_dob = ?, class_id = ? "
					+ "where student_id = ?";
			CallableStatement callableStatement = connection.prepareCall(sql);
			callableStatement.setInt(4, student.getStudentId());
			callableStatement.setString(1,student.getStudentName());
			callableStatement.setDate(2, student.getStudentDOB() );
